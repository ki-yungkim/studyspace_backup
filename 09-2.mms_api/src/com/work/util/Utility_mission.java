 ...
 *
 */
public class Utility_mission {
	public static void main(String[] args) {
//		System.out.println("현재날짜");
		print("현재날짜");
		System.out.println(Utility_mission.getCurrentDate());
		System.out.println(Utility_mission.getCurrentDate("MM-dd-yyyy"));
		System.out.println(Utility_mission.getCurrentDate("MM/dd/yyyy [a] hh:mm"));
		System.out.println(Utility_mission.getCurrentDate("MM/dd/yyyy [a] hh:mm", Locale.US));
		System.out.println(Utility_mission.getCurrentDate("MM/dd/yyyy [a] hh:mm", Locale.CHINA));
		System.out.println(Utility_mission.getCurrentDate("HH:mm"));
		System.out.println(Utility_mission.getCurrentDate("[a]hh:mm"));
		System.out.println(Utility_mission.getCurrentDate("[a]hh:mm", Locale.US));
